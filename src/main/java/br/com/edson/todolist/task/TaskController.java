package br.com.edson.todolist.task;
...
import br.com.edson.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        var tastCreated = taskRepository.save(taskModel);
        return ResponseEntity.status(HttpStatus.CREATED).body(tastCreated);
    }
